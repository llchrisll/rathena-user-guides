...
```
set .@NameOfGuildVar$, "$CastCapt"+getcharid](getcharid)(2); 
// If your guild ID would be 204, the contents of 
// .@NameOfGuildVar$ would be: "$CastCapt204"
set .@Score, getd](getd)(.@NameOfGuildVar$); // Retreive the current score.
...
[announce](announce) "I have found "+.@FivesFound+" occurances of 5 in your multidimensional array.",bc_all;
```
...
   if(getvariableofnpc](getvariableofnpc)(.unlocked,"PvP Unlocker")) {
...
When used inside scripts, their value is not always constant, but can change depending in context and time. Some of them can be written as well, such as Zeny.
